...
async function initialize() {
    ...
    db.connection = await mysql.createPool({ host, port, user, password, database });
  ...
  //  await db.connection.query(`CREATE DATABASE IF NOT EXISTS \`BCHAddressPool\`;`);
    ...
    // connect to db
    const sequelize = new Sequelize('mysql://bebe19c45805a2:9b0bb6ca@us-cdbr-east-03.cleardb.com/heroku_9dedb930f2ef1f5?reconnect=true', { dialect: 'mysql' });
